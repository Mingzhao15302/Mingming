  ...
  const toggleFullscreen = () => {
    ...
    if (isWrapperInFullscreen()) {
      if (document.exitFullscreen) {
        ...
        action = document.webkitExitFullscreen();
      }
    } else if (videoWrapper.requestFullscreen) {
      action = videoWrapper.requestFullscreen();
    } else if (videoElement.requestFullscreen) {
      action = videoElement.requestFullscreen();
    } else if (videoWrapper.webkitRequestFullscreen) {
      action = videoWrapper.webkitRequestFullscreen();
    } else if (videoElement.webkitRequestFullscreen) {
      action = videoElement.webkitRequestFullscreen();
    }
